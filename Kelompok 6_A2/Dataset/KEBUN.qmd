...
<qgis version="3.40.10-Bratislava">
  <identifier>AGRIKEBUN_AR_50K</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>AGRIKEBUN_AR_50K</title>
  <abstract>Segala kegiatan yang mengusahakan tanaman tertentu pada tanah dan atau media tumbuh lainnya dalam ekosistem yang sesuai, mengolah dan memasarkan barang dan jasa hasil tanaman tersebut, dengan bantuan ilmu pengetahuan dan teknologi
  ...
  <links>
    <link name="" description="" url="file://\\DEMON\C$\Geodatabase_FDS.gdb" type="Local Area Network" size="" mimeType="" format=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
