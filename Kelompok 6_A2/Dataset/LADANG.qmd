...
<qgis version="3.40.10-Bratislava">
  <identifier>AGRILADANG_AR_50K</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>AGRILADANG_AR_50K</title>
  <abstract>Lahan kering yang ditanami tanaman musiman atau tahunan seperti padi ladang, palawija/hortikultura dan letaknya terpisah dengan halaman sekitar rumah.
  ...
  <links>
    <link name="" description="" url="file://\\PC-2\H$\Almanggari\BSDU\FDS\Basis Data Spasial\FDS-Geodata.gdb" type="Local Area Network" size="" mimeType="" format=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
